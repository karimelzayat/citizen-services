      ...
      {isOpen && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 md:p-8 overflow-hidden RTL" dir="rtl">
          ...
          <motion.div 
            ...
            className="relative bg-white dark:bg-slate-900 shadow-2xl rounded-[40px] border border-slate-100 dark:border-white/5 p-0 flex flex-col w-full max-w-md h-auto max-h-[85vh] overflow-hidden" 
          ...
          >
            <div className="p-6 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between">
              <div className="flex items-center gap-4">
                 ...
                 <div className="text-right">
                   ...
                   <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">إحصائيات الشيفت الحالي</p>
                 </div>
              </div>
            ...
            <div className="p-6 space-y-4 bg-white dark:bg-slate-900 overflow-y-auto custom-scrollbar bg-slate-50/20">
              {loading ? (
                ...
                <div className="h-40 flex flex-col items-center justify-center text-slate-400 opacity-40">
                   ...
                   <p className="font-black text-lg">لا توجد بيانات أداء حتى الآن</p>
                </div>
              )}
            </div>

            <div className="p-6 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-white/5">
                <div className="bg-linear-to-br from-indigo-600 to-blue-700 p-5 rounded-3xl border border-blue-500/10 flex items-center justify-between shadow-xl shadow-blue-500/20 text-white">
                   <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center text-white backdrop-blur-md">
                         <User className="w-6 h-6" />
                      </div>
                      <div className="text-right">
                        <span className="text-[10px] font-black text-white/60 uppercase tracking-widest block mb-0.5">مركزك الحالي في المنظومة:</span>
                        <span className="text-xl font-black tracking-tight flex items-center gap-2">
                          السابع (#7)
                          <span className="px-2 py-0.5 bg-emerald-500 text-white text-[9px] rounded-lg animate-pulse">متصل</span>
                        </span>
                      </div>
                   </div>
